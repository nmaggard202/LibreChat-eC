  ...
  return (
    <div className="rounded-md border border-border-light p-3">
      <div className="flex items-center justify-between font-medium">
        ...
        {isActive && (
          <span className="rounded-full border border-red-600 bg-red-600/20 px-2 py-0.5 text-xs font-medium text-red-700 dark:border-red-500 dark:bg-red-500/30 dark:text-red-300">
