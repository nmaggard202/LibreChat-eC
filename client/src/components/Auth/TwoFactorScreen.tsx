      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-2xl bg-red-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-red-700 disabled:opacity-80 dark:bg-red-600 dark:hover:bg-red-700"
          >
