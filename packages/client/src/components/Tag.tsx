...
const TagPrimitiveRoot = React.forwardRef<HTMLDivElement, TagProps>(
  (
    ...
    <div
      ...
      {...props}
      className={cn(
        'flex max-h-8 items-center overflow-y-hidden rounded-3xl border-2 border-red-600 bg-red-600/20 text-xs text-red-600 dark:text-white',
        className,
      )}
    >
      ...
      {CancelButton
        ...
        : onRemove && (
            <button
              ...
              className="rounded-full bg-red-600/50"
